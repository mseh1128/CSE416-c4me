...
create table college (collegeName VARCHAR(200) NOT NULL, state VARCHAR(2) NOT NULL, region VARCHAR(45) NOT NULL, ACTComposite INT NOT NULL, SATEBRWScore INT NOT NULL, SATMathScore INT NOT NULL, admissionRatePercent INT NOT NULL, `rank` INT NOT NULL, institutionType VARCHAR(45) NOT NULL, medianCompletedStudentDebt INT NOT NULL, size VARCHAR(45) NOT NULL);
create table college_declaration (userID INT NOT NULL, personName VARCHAR(30) NOT NULL, collegeName VARCHAR(90) NOT NULL, questionable BOOL NOT NULL, PRIMARY KEY (`userID`));
...
create table student (userID INT NOT NULL, state VARCHAR(20), highSchoolCity VARCHAR(50), major1 VARCHAR(20), major2 VARCHAR(20), highSchool VARCHAR(20), PRIMARY KEY (`userID`));
...
-- SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA="college_recommender";
