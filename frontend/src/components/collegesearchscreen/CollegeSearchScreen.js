...
export class CollegeSearchScreen extends Component {
  state = {
    ...
    filters: {
      admissionRateValues: [admissionRate.min, admissionRate.max],
      costOfAttendanceValues: [costOfAttendance.min, costOfAttendance.max],
      rank: [rank.min, rank.max],
      size: [size.min, size.max],
      avgMathScore: [avgSAT.min, avgSAT.max],
      avgEBRWScore: [avgSAT.min, avgSAT.max],
      avgACTScore: [avgACT.min, avgACT.max],
      location: '',
      major1: '',
      major2: '',
      strict: false,
  ...
  searchForColleges = async () => {
    ...
    try {
      console.log('in search for colleges');
