...
export class CollegeSearchScreen extends Component {
         state = {
           ...
           filters: {
             ...
             costOfAttendanceValues: [0, 10000],
             rank: [1, 1000],
             size: [1, 20000],
         ...
         componentDidMount = async () => {
           try {
             ...
             const [allColleges, studentDecNamesData] = await Promise.all([
               axios.get('/getAllColleges'),
               axios.get('/getDeclaredCollegeNames', {
                 params: { userID },
               }),
             ]);
         ...
         recommendColleges = async () => {
           ...
           try {
             ...
             recColleges.forEach((college) => {
               ...
               if (
                 collegeRecData.data[name] !== null &&
                 collegeRecData.data[name] !== undefined
               ) {
         ...
         goSimilarStudents = (name) => {
           let similarStudents = this.state.recColleges[name]
         ...
         goAppTracker = async (id) => {
           ...
           try {
             ...
             queryStudentsDecisions = await axios.get(
               '/retrieveStudentsDecisions',
               {
                 params: {
                   collegeName: id,
                 },
         ...
         deleteMajor = (key) => {
           let newList = this.state.majorList.filter(
             (item) => item.key !== key
           );
           this.setState({ majorList: newList });
           //update filters
         ...
         sortColleges = () => {
           ...
           if (currentSortType === 'nameDn') {
             ...
             return colleges.sort((a, b) =>
               this.sortingFunction(a.recScore, b.recScore, false)
             );
           } else {
         ...
         render() {
           ...
           if (
             ...
             (this.state.colleges.length == 0 &&
               !this.state.componentFinishedLoad)
           ) {
                           ...
                           if (index === 0) {
                             return (
                               ...
                               >
                                 ...
                                 >
                                   {this.state.filters.avgMathScore[
                                     index
                                   ].toFixed(1)}
                                 </div>
                                 <div
                           ...
                           if (index === 0) {
                             return (
                               ...
                               >
                                 ...
                                 >
                                   {this.state.filters.avgEBRWScore[
                                     index
                                   ].toFixed(1)}
                                 </div>
                                 <div
                             ...
                             if (index === 0) {
                               return (
                                 ...
                                 >
                                   ...
                                   >
                                     {this.state.filters.avgACTScore[
                                       index
                                     ].toFixed(1)}
                                   </div>
                                   <div
