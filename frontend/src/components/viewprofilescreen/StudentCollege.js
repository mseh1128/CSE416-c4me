...
class StudentCollege extends React.Component {
  ...
  getCity = () => {
    if (
      this.props.college.city === undefined ||
      this.props.college.city === null
    ) {
      return 'Unknown';
  ...
  getState = () => {
    if (
      this.props.college.state === undefined ||
      this.props.college.state === null
    ) {
      return 'Unknown';
  ...
  getAdmissionRate = () => {
    if (
      ...
      return (
        Math.floor(this.props.college.admissionRatePercent * 10000) / 100 + '%'
      );
  };
  ...
  getCompletionRate = () => {
    if (
      ...
      return Math.floor(this.props.college.completionRate * 100) / 100 + '%';
  };

  getRank = () => {
    if (
      this.props.college.ranking === undefined ||
      this.props.college.ranking === null
    ) {
      return '?';
  ...
  getSize = () => {
    if (
      this.props.college.size === undefined ||
      this.props.college.size === null
    ) {
      return 'Unknown';
  ...
  getMathScore = () => {
    if (
      this.props.college.SATMathScore === undefined ||
      this.props.college.SATMathScore === null
    ) {
      return 'Unknown';
  ...
  getEnglishScore = () => {
    if (
      this.props.college.SATEBRWScore === undefined ||
      this.props.college.SATMathScore === null
    ) {
      return 'Unknown';
  ...
  getACTScore = () => {
    if (
      this.props.college.ACTScore === undefined ||
      this.props.college.ACTScore === null
    ) {
      return 'Unknown';
  ...
  checkRec = () => {
    if (
      ...
      this.props.college.recScore === undefined
    ) {
      return true;
    } else return false;
  };
    ...
    return (
      <div className="collegeContainer">
        ...
        <button
          ...
          onClick={this.props.removeApplication.bind(
            this,
            college.collegeName,
            this.props.index
          )}
