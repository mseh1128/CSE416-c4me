...
export class ViewProfileScreen extends Component {
  ...
  stopAndSaveEdit = async() => {
    let id = data.student.key;

    let resState = document.getElementById("residence_state").value;
    let highSchoolCity = document.getElementById("high_school_city").value;
