...
export class ApplicationGraph extends Component {
	...
	getOtherValuesSAT = () => {
		...
		this.state.students.forEach((student) => {
			if (student.acceptanceStatus !== 'denied' && student.acceptanceStatus !== 'accepted') {
				if (student.SATMath !== null && student.SATEBRW !== null) {
					data[num] = {
						x: student.SATMath + student.SATEBRW,
						y: student.highSchoolGPA,
				...
				<div className='schoolsContainer'>
					...
					<div>
						<div id='graphContainerSAT' hidden={this.isHidden('SAT')}>
							...
							/>
							<div className='meanLineGPA' style={{ bottom: this.getMeanGPA() + 'px' }} />
							<div className='meanLineOther' style={{ left: this.getMeanSAT() + 'px' }} />
						</div>
						<div id='graphContainerACT' hidden={this.isHidden('ACT')}>
							...
							/>
							<div className='meanLineGPA' style={{ bottom: this.getMeanGPA() + 'px' }} />
							<div className='meanLineOther' style={{ left: this.getMeanACT() + 'px' }} />
						</div>
						<div id='graphContainerStandard' hidden={this.isHidden('Standardized Tests')}>
							<ResponsiveScatterPlot
								data={standardData}
								margin={{ top: 60, right: 140, bottom: 70, left: 90 }}
						...
						<div id='graphBtnContainer'>
							...
							<div></div>
							<button className='graphBtns' onClick={this.setGraphType.bind(this, 'SAT')}>
								SAT
							</button>
							<div></div>
							<button className='graphBtns' onClick={this.setGraphType.bind(this, 'ACT')}>
								ACT
							</button>
							<div></div>
							<button
